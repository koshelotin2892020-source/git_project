...
urlpatterns = [
    ...
    path('courses/<int:course_id>/add-student/', views.add_student_to_course, name='add_student_to_course'),
    
    # Студенты
    path('students/', views.student_list, name='student_list'),
    path('students/<int:student_id>/', views.student_detail, name='student_detail'),
    path('students/create/', views.student_create, name='student_create'),
    path('students/create-form/', views.student_create_form, name='student_create_form'),
    ...
    path('students/<int:student_id>/unenroll/<int:course_id>/', views.unenroll_student, name='unenroll_student'),
