...
def main():
    while True:
        ...
        print("1 - Проверка чисал на четность")
        print("2 - Сравнение двух чисел")
        print("3 - Таблица умножения числа")
        print("4 - Сумма чисел в диапазоне")
        print("5 - Возведение в степень")
        print("6 - Проверка возраста")
        print("7 - Факториал числа")
        print("8 - Работа с цифрами числа")
        print("9 - Проверка символа")
        print("10 - Циклы с условием")
        print("0 - Выход")
        print("="*50)
